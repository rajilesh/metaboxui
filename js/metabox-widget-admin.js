...
;(function ( $, window, document, undefined ) {
  ...
  $(document).ready( function(){
    $('.hide-color-picker.ot-colorpicker-opacity').ot_wpColorPicker();
      ...
      jQuery('[name="savewidget"]').click(function(){
          
          
        var widget =  jQuery(this).parents('form');
         setTimeout(function (){
              add_select_classes(widget);
         },100);
         setTimeout(function (){
              add_select_classes(widget);
         },200);
      ...
      function add_select_classes(widget){
          var select = widget.find('.option-tree-ui-select');
